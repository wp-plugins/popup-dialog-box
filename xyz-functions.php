...
function xyz_dbx_links($links, $file) 
{
	...
	if ($file == $base) 
	{
		...
		$links[] = '<a href="http://kb.xyzscripts.com/wordpress-plugins/popup-dialog-box/"  title="FAQ">FAQ</a>';
		$links[] = '<a href="http://docs.xyzscripts.com/wordpress-plugins/popup-dialog-box/"  title="Read Me">README</a>';
