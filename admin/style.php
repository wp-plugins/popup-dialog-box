...
#popup-dialog-box .xyz_gplus{
margin-left: 3px;
}

#popup-dialog-box .plugin-version-author-uri {
...
#popup-dialog-box .plugin-version-author-uri a,
#popup-dialog-box .plugin-version-author-uri a:link,
#popup-dialog-box .plugin-version-author-uri a:hover,
#popup-dialog-box .plugin-version-author-uri a:active,
#popup-dialog-box .plugin-version-author-uri a:visited{
...
#popup-dialog-box .plugin-version-author-uri a#xyz_update,
#popup-dialog-box .plugin-version-author-uri a#xyz_update:link,
#popup-dialog-box .plugin-version-author-uri a#xyz_update:hover,
#popup-dialog-box .plugin-version-author-uri a#xyz_update:active,
#popup-dialog-box .plugin-version-author-uri a#xyz_update:visited
{
color: red;
font-weight: bold;
