    ...
    <tr style="background-color: #EDEDED"><td ><h2>Feature group</h2></td><td><h2>Feature</h2></td><td><h2> Popup Dialog Box</h2> </td> <td><h2>XYZ WP Popup</h2></td> </tr>
     <tr ><td rowspan="5"><h4>Display Layout</h4></td><td >As lightbox </td><td> <img src="<?php echo plugins_url("images/cross.png",__FILE__);?>"></td> <td><img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td> </tr>
        <tr><td>As full screen popup</td><td> <img src="<?php echo plugins_url("images/cross.png",__FILE__);?>"></td> <td><img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td>  </tr>
          <tr><td>As popup dialog box</td><td> <img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td> <td><img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td>  </tr>
      ...
      <tr ><td rowspan="3"><h4>Title Settings</h4></td><td >Title </td><td> <img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td> <td><img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td> </tr>
        <tr><td>Title color</td><td> <img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td> <td><img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td>  </tr>
      <tr><td>Title font size</td><td> <img src="<?php echo plugins_url("images/cross.png",__FILE__);?>"></td> <td><img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td>  </tr>
     ...
     <tr ><td rowspan="2"><h4>Special Effects</h4></td><td >Popup sliding </td><td> <img src="<?php echo plugins_url("images/cross.png",__FILE__);?>"></td> <td><img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td> </tr>
        <tr><td>Popup dragging</td><td> <img src="<?php echo plugins_url("images/cross.png",__FILE__);?>"></td> <td><img src="<?php echo plugins_url("images/tick.png",__FILE__);?>"></td>  </tr>                   
